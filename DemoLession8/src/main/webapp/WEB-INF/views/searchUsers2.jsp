...
<body>
	...
	<form method="get" action="searchUsers2">
		<label>UserName:</label>
		 <input type="text" id="userName" name="searchInput"><br> 
		 <input type="submit" value="Save">
	</form>

	<h1>
		<u>Đây là danh sách user:</u>
	</h1>
	<table border="1">
		<tr bgcolor="#6666FF">
		...
		<c:forEach var="user" items="${listUsers}">
			<tr bgcolor="green">
				...
				<th style="font-size: 50px"><button style="font-size: 50px"
						onclick="myFunction(${user.id})">DeleteByUser</button>
					<br></th>
				<th style="font-size: 50px"><a
					href="/deleteByIdUser/${user.id}">DeleteById</a><br></th>
